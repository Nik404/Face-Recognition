...
print("-"*30);print("Capturing Image");print("-"*30)
...
print("-"*30);print(data.shape);print("-"*30)

suffix = input("Enter image name: ")
# save the data as a numpy matrix in an encoded format

np.save('face_0'+suffix, data)
print("-"*30);print("Face Capturing Complete");print("-"*30)
