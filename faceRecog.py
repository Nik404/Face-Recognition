...
f_01 = np.load('face_01.npy').reshape((20, 50*50*3))	# Raunak
f_02 = np.load('face_02.npy').reshape((20, 50*50*3))	# Nikhil
f_03 = np.load('face_03.npy').reshape((20, 50*50*3))	# Yash
...
labels[:20, :] = 0.0	# first 20 for raunak (0)
labels[20:40, :] = 1.0	# next 20 for nikhil (1)
labels[40:, :] = 2.0	# last 20 for yash (2)
